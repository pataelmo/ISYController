...
public class VariableTreeViewActivity extends FragmentActivity {
...
//		bundle.putString("id", mId);
		...
		VariableTreeFragment fragment = new VariableTreeFragment();
...
//
//         });
        Log.i("VariableTreeActivity","Created:"+this);
	}
	...
	protected void onPause() {
		super.onPause();
		Log.v("VariableTreeActivity","Paused:"+this);
//		mListPosition = mList.getFirstVisiblePosition();
	...
	protected void onStop() {
		super.onStop();
		Log.v("VariableTreeActivity","Stopped:"+this);
	}
	...
	protected void onRestart() {
		super.onRestart();
		//refreshListData();
		Log.v("VariableTreeActivity","Restarted:"+this);
	}
...
//		Log.v("VariableTreeActivity","Resumed:"+this);
	}
