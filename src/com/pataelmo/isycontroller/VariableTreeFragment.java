...
public class VariableTreeFragment extends ListFragment implements ISYRESTInterface.ISYRESTCallback {
	...
	public void onCreate(Bundle savedInstance) {
        ...
        if (savedInstance == null) {
        	...
        	//"/definitions/1","/get/1","/definitions/2","/get/2"
        	new ISYRESTInterface(this, this, true).execute("/vars/definitions/1","/vars/get/1","/vars/definitions/2","/vars/get/2");
        }
	}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        mActivity.updateTitle("Variables", false);
